-- Keep accepting the previous consent version for interviews already open in a
-- browser while validating the updated Google Forms disclosure for new ones.
...
begin
  ...
  if p_event_invitation_opt_in and (
    p_event_invitation_consent_version is null
    or p_event_invitation_consent_version not in (
      '2026-09-22-event-funnel-v1',
      '2026-09-23-google-forms-v1'
    )
