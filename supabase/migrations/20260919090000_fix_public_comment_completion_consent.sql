-- Keep completion compatible with the late-Google-auth consent flow.
-- The application sends 2026-09-18-late-google-auth-v1 after the interview,
-- while sessions created before that flow may still carry the receipt version.
