...
function request(extra: Record<string, unknown> = {}) {
  return new Request("http://localhost/api/public-comment/ijime/complete", {
    method: "POST",
    body: JSON.stringify({
      sessionId: "session-1",
...
describe("POST /api/public-comment/ijime/complete", () => {
  beforeEach(() => {
    vi.resetAllMocks();
  ...
  it("認証済み本人かついじめキャンペーンのセッションだけを完了する", async () => {
