    ...
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              ...
              "本サービスの改善・新規開発",
              "広告からパブリックコメント作成支援、イベント案内、申込、来場までの利用状況の集計と施策改善",
              "上記の各利用目的に必要な各種調査・分析",
          ...
          <LegalParagraph>
            イベントへ申し込む場合、氏名、メールアドレス、関心分野、参加にあたっての連絡事項、申込日時、来場状況を取得し、イベントの連絡、安全な運営、広告から来場までの集計に使用します。申込情報と来場状況は管理者だけが確認し、外部へ公開しません。
          </LegalParagraph>
          <LegalParagraph>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            控えや活動・イベント案内の受信設定、選択日時、同意文面の版をインタビューごとに保存します。送信のため、Googleログインで取得したメールアドレス、控えの会話全文と本人確認済みコメント、イベント案内の固定文をメール配信サービスResendへ渡します。重複送信の防止と障害確認のため、送信先・確定した本文・HTML本文・送信受付状態、配信・不達等の状態も保存します。イベント案内に個別のインタビュー回答を含めません。メールアドレスや受信設定をAIへの入力や公開コメントには含めません。案内メール内の申込リンクをクリックした日時は、イベント案内の効果確認のため記録しますが、メールを開封しただけでは記録しません。
          </LegalParagraph>
          <LegalParagraph>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            広告からイベント来場までの計測では、ランダムな流入識別子をブラウザのセッションストレージに保存します。氏名、メールアドレス、インタビュー回答本文をGoogleアナリティクスや広告事業者へ送信するためには使用しません。
          </LegalParagraph>
        </section>
