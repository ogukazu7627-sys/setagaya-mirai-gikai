    ...
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            控えの受信設定、選択日時、同意文面の版をインタビューごとに保存します。送信のため、Googleログインで取得したメールアドレス、会話全文、本人確認済みコメントをメール配信サービスResendへ渡します。重複送信の防止と障害確認のため、送信先・確定した本文・送信状態も保存します。メールアドレスや受信設定をAIへの入力や公開コメントには含めません。開封・クリックの追跡は行いません。
          </LegalParagraph>
          <LegalParagraph>
            控えが不要な場合は、最終文章を表示するためのGoogleログイン画面または下書き確認画面で受信欄のチェックを外してください。完了後に送信済みのメールは取り消せません。以前取得した活動案内の配信希望は別の記録として保持し、今回の控え送信には使用しません。以前の配信希望の撤回や、個人情報の確認・削除は本サービスのお問い合わせ窓口へご相談ください。
          </LegalParagraph>
        </section>
