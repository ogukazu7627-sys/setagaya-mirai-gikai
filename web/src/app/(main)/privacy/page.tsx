        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              ...
              "AIインタビュー完了後に、利用者本人のGoogle Drive上へGoogle Docs形式の請願書下書きを作成すること",
          ...
          <LegalParagraph>
            Google
            Docs形式の請願書下書きを作成する場合、利用者本人の追加同意に基づき、Google
            Drive上に本サービスが作成したファイルを作成・編集するための権限を利用します。この権限により取得したGoogleのアクセストークンは、下書き作成の処理中にのみ使用し、本サービスのデータベースには保存しません。住所、氏名、電話番号など請願者本人の情報は、本サービス側では入力・保存せず、作成後のGoogle
            Docs上で利用者自身が記入します。
          </LegalParagraph>
          <LegalParagraph>
