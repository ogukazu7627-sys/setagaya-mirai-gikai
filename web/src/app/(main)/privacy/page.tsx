    ...
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            控えが不要な場合は、開始前の同意画面または下書き確認画面で受信欄のチェックを外してください。完了後に送信済みのメールは取り消せません。以前取得した活動案内の配信希望は別の記録として保持し、今回の控え送信には使用しません。以前の配信希望の撤回や、個人情報の確認・削除は本サービスのお問い合わせ窓口へご相談ください。
          </LegalParagraph>
        </section>
