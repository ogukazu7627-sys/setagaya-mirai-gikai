    ...
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            控えや活動・イベント案内の受信設定、選択日時、同意文面の版をインタビューごとに保存します。送信のため、Googleログインで取得したメールアドレス、控えの会話全文と本人確認済みコメント、イベント案内の固定文をメール配信サービスResendへ渡します。重複送信の防止と障害確認のため、送信先・確定した本文・HTML本文・送信状態も保存します。イベント案内に個別のインタビュー回答を含めません。メールアドレスや受信設定をAIへの入力や公開コメントには含めません。開封・クリックの追跡は行いません。
          </LegalParagraph>
          <LegalParagraph>
