    ...
    >
      <Container className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            控えや活動・イベント案内の受信欄は初期状態でチェックされていますが、利用規約・回答保存への必須同意とは別の任意設定です。最終文章を表示するためのGoogleログイン画面と下書き確認画面でまとめて変更でき、選択・日時・同意文面の版を記録します。送信にはResendを使用します。メール受信は、コメントの匿名公開、議員への連絡先共有への同意とは別です。イベント案内にはインタビューの個別回答を含めません。メールは区への正式な提出を行うものではなく、到着を保証するものでもありません。
          </LegalParagraph>
        </section>
      </Container>
    </LegalPageLayout>
