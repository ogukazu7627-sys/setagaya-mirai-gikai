    ...
    >
      <Container className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            控えメールの受信欄は初期状態でチェックされていますが、利用規約・回答保存への必須同意とは別の任意設定です。最終文章を表示するためのGoogleログイン画面と下書き確認画面で変更でき、選択・日時・同意文面の版を記録します。送信にはResendを使用します。控えの受信を、活動案内、コメントの匿名公開、議員への連絡先共有への同意とみなすことはありません。控えメールは区への正式な提出を行うものではなく、到着を保証するものでもありません。
          </LegalParagraph>
        </section>
      </Container>
    </LegalPageLayout>
