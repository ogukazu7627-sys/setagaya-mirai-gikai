...
export default function BillCardPreview() {
  ...
  const featuredBill = createMockBill({
    ...
    bill_content: {
      ...
      title: "注目の案件タイトル",
      summary:
        "注目フラグが立っている案件のカード表示。注目バッジが表示されます。",
      content: "",
  ...
  const longTitleBill = createMockBill({
    ...
    bill_content: {
      ...
      title:
        "デジタル社会の形成を図るための関係条例・議案の整備に関する条例・議案の一部を改正する条例・議案案についての補足的な検討事項を含む修正案",
      summary:
        "この案件は開発プレビュー用のサンプルデータです。案件の要約文がここに表示されます。",
      content: "",
      difficulty_level: "normal",
      created_at: "2026-02-15T00:00:00Z",
      updated_at: "2026-02-15T00:00:00Z",
  ...
  const longDescriptionBill = createMockBill({
    ...
    bill_content: {
      ...
      title: "サンプル案件のタイトル",
      summary:
        "この案件はデジタル社会の形成を推進するため、行政手続のオンライン化、マイナンバーカードの利活用促進、データの標準化・連携基盤の整備、サイバーセキュリティ対策の強化、個人情報保護制度の見直し、AI技術の適正利用に関するガイドラインの策定、地方自治体のDX推進支援、デジタルデバイド解消のための施策等について、関係する複数の条例・議案を一括して改正するものです。特に高齢者や障害者を含む全ての区民がデジタル化の恩恵を享受できる社会の実現を目指しています。",
      content: "",
      difficulty_level: "normal",
      created_at: "2026-02-15T00:00:00Z",
      updated_at: "2026-02-15T00:00:00Z",
  ...
  return (
    <>
      ...
      <ComponentShowcase title="Default" description="基本的な案件カード">
