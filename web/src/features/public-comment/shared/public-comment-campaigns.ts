...
export type PublicCommentCampaignIcon =
  | "accessibility"
  | "brain"
  | "care"
  | "community"
...
export type PublicCommentCampaign = {
  label: string;
  title: string;
  description: string;
  deadline: string;
  href: Route;
  icon: PublicCommentCampaignIcon;
};

export const PUBLIC_COMMENT_CAMPAIGNS = [
  {
    label: "高齢者・介護",
  ...
  },
  {
    ...
    description:
      "歩行者、自転車、小型モビリティなど、日常の移動を安全にする対策を考えます。",
...
] as const satisfies readonly PublicCommentCampaign[];
