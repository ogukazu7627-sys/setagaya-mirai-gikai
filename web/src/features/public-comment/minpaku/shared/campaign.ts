...
export const MINPAKU_QUESTIONS = [
  {
    ...
    topic: "関わり方",
    context:
      "今回の見直しでは、届出で営業する「住宅宿泊事業」と、許可を受けて営業する「旅館業」の両方を扱っています。住宅やマンションを使った宿泊施設でも、どちらの制度で営業しているかによって、適用されるルールが異なります。",
    question:
  ...
  },
  {
    ...
    topic: "関心のある論点",
    context:
      "今回の改正では、事前周知、連絡先の表示、ごみの処理、緊急時の駆けつけ体制などの管理ルールを強化する一方、一定の条件を満たす家主居住型などには、住居専用地域でも年間180日まで営業できるようにする見直しが示されています。",
    question: "このうち、あなたが特に意見を伝えたいのは、どの部分ですか。",
    quickReplies: [
      "騒音やごみ",
      "防災・安全",
      "苦情への対応",
  ...
  },
  {
    ...
    topic: "区の説明との関係",
    context:
      "今回の改正について、区は、住環境を守るために事業者の管理ルールを強化するとともに、適正に運営する事業者との共生を図るという考え方を示しています。",
    question:
  ...
  },
  {
    ...
    topic: "必要な条件",
    context:
      "現行の区のガイドラインにも、営業期間の制限を変更する際、事業者が住民に説明した内容、住民の意見、生活環境の悪化を防ぐ措置などを確認して判断する仕組みがあります。",
    question:
  ...
  },
  {
    ...
    topic: "具体的な提案",
    context:
      "住宅宿泊事業については、現在も周辺住民への事前周知、苦情への対応、区による立入検査や業務改善命令などの仕組みがあります。今回の改正では、それらに関わるルールを見直すとともに、不適正な運営が認められた場合に、営業期間の制限解除を取り消す規定を設ける方針です。",
    question:
