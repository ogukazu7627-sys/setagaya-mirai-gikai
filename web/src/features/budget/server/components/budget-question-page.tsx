...
import { BudgetQuestionAiChatProvider } from "@/features/budget/client/components/budget-question-ai-chat";
...
>;
type BudgetQuestion = BudgetQuestionCategoryPageData["questions"][number];
...
function getBudgetQuestionMetaText(question: BudgetQuestion): string | null {
...
function BudgetQuestionCouncilorSlide({
  focusBillId,
  questions,
}: {
  focusBillId?: string | null;
  ...
  return (
    <div className="space-y-12" data-budget-councilor-questions>
