...
} from "@mirai-gikai/shared/councilor-digest/email-body";
...
export async function listPendingCouncilorDigestGroups() {
...
function toDigestItem(row: PendingRecipientRow): DigestReportItem {
  ...
  return {
    reportId: report.id,
    billTitle,
    billUrl: `${env.webUrl.replace(/\/+$/, "")}/bills/${billId}`,
