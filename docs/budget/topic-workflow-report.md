...
| 子育て | 1 | 17 | 17 | 0 | 0 | 17 | 0 |
| 福祉 | 1 | 23 | 23 | 0 | 9 | 14 | 0 |
| まちづくり | 1 | 5 | 4 | 1 | 1 | 4 | 0 |
| 防災 | 1 | 25 | 21 | 4 | 4 | 21 | 0 |
| 行財政 | 1 | 8 | 6 | 2 | 2 | 6 | 0 |
| 文化・スポーツ | 1 | 16 | 14 | 2 | 2 | 14 | 0 |
| 産業 | 1 | 25 | 20 | 5 | 5 | 20 | 0 |
| 環境問題 | 1 | 6 | 6 | 0 | 0 | 6 | 0 |
| 暮らし | 1 | 34 | 34 | 0 | 0 | 34 | 0 |
...
| 子育て | 保育サービスと保育環境の充実 | 17 | 17 | 0 | 17 | 0 | 0 | 0 | not_published |
| 福祉 | 介護予防と地域生活の支援 | 23 | 23 | 0 | 14 | 0 | 9 | 0 | not_published |
| まちづくり | 道路・橋梁の維持と安全確保 | 5 | 4 | 1 | 4 | 0 | 1 | 0 | not_published |
| 防災 | 災害への備えと地域防災力の向上 | 25 | 21 | 4 | 21 | 0 | 4 | 0 | not_published |
| 行財政 | 行政サービスと情報基盤のデジタル化 | 8 | 6 | 2 | 6 | 0 | 2 | 0 | not_published |
| 文化・スポーツ | スポーツに親しめる環境づくり | 16 | 14 | 2 | 14 | 0 | 2 | 0 | not_published |
| 産業 | 地域の事業者と産業の成長支援 | 25 | 20 | 5 | 20 | 0 | 5 | 0 | not_published |
| 環境問題 | 脱炭素と再生可能エネルギーの推進 | 6 | 6 | 0 | 6 | 0 | 0 | 0 | not_published |
| 暮らし | 身近な地域施設の維持と活用 | 34 | 34 | 0 | 34 | 0 | 0 | 0 | not_published |

## 運用ルール

- `A_official_direct` は公開7ファイルだけを根拠とする今回の候補生成では使用しない。
- Bは公式の款・項・目、事業名、部署名から構造的に強く判断できる候補である。
- Bかつ確信度Highの146件は、承認済みの編集ルールにより`approve`とする。
- Bでも確信度Medium/Lowの候補とC候補は、ローカル画面で個別に人間が確認する。
